...
export function CourseDetails({ course }: CourseDetailsProps) {
  ...
  const mobileHeroImage = courseMobileHeroImages[course.nameRU] ?? heroImage;
  ...
  const benefits =
    course.nameRU === "Йога" ? yogaBenefits : course.directions.slice(0, 5);
  ...
  return (
    <div className={styles.wrapper}>
      ...
      <section className={styles.fittingSection}>
        ...
        <div className={styles.fittingGrid}>
          {fittingItems.map((item, index) => (
            <article key={item} className={styles.fittingCard}>
      ...
      <section className={styles.cta}>
        <div className={styles.ctaDecorationDesktop} aria-hidden="true">
          <Image
        ...
        <div className={styles.ctaVisualMobile} aria-hidden="true">
          <Image
